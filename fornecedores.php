<?php
    ...
    {
        $data = $_GET['search'];
        $sql = "SELECT * FROM fornecedores WHERE id LIKE '%$data%' or empresa LIKE '%$data%' or cnpj LIKE '%$data%' or telefone LIKE '%$data%' or telefone_fixo LIKE '%$data%' or email LIKE '%$data%' or rua LIKE '%$data%' or numero LIKE '%$data%' or complemento LIKE '%$data%' or bairro LIKE '%$data%' or cidade LIKE '%$data%' or estado LIKE '%$data%' or cep LIKE '%$data%' ORDER BY id ASC";
    }
    else
    {
...
<table id="tabela-tabela">
    ...
    <tbody>
        <?php
            ...
            {
                echo "<tr>";
                echo "<td>".$empresa = $user_data['empresa']."</td>";
                echo "<td>".$cnpj = $user_data['cnpj']."</td>";
                echo "<td>".$telefone_fixo = $user_data['telefone_fixo']."</td>";
                echo "<td>".$telefone = $user_data['telefone']."</td>";
                echo "<td>".$email = $user_data['email']."</td>";
                echo "<td class='botoes-acao'>
                      <a class='botao-editar' href='edit/editFornec.php?id=$user_data[id]'>
                        <svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-pencil-fill' viewBox='0 0 16 16'>
                        <path d='M12.854.146a.5.5 0 0 0-.707 0L10.5 1.793 14.207 5.5l1.647-1.646a.5.5 0 0 0 0-.708l-3-3zm.646 6.061L9.793 2.5 3.293 9H3.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.207l6.5-6.5zm-7.468 7.468A.5.5 0 0 1 6 13.5V13h-.5a.5.5 0 0 1-.5-.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.5-.5V10h-.5a.499.499 0 0 1-.175-.032l-.179.178a.5.5 0 0 0-.11.168l-2 5a.5.5 0 0 0 .65.65l5-2a.5.5 0 0 0 .168-.11l.178-.178z'/>
                        </svg>
                      </a>
                      <a class='botao-excluir' href='process/processDeleteFornec.php?id=$user_data[id]'>
...
<a class="link-cadastro-table" href="cadastro/cadastroFornec.php"><input class="botao-cadastro-table" name="cadastro" id="cadastro" type="submit" value="Cadastrar Fornecedor"></a>
</div>
<br>
<footer>
